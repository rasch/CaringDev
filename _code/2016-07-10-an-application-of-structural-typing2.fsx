...
(**
At some point you'll find yourself doing <abbr title="Extract, Transform, Load">ETL</abbr>.
...
<i class="fi-checkbox"></i> <strong>E</strong>xtraction, fast and easy
</div>
...
<div class="col-md-5 col-sm-6 col-xs-12">
*)
type Nullable<'T when 'T : (new : unit -> 'T) and 'T : struct and 'T :> ValueType> = System.Nullable<'T>
(**
</div>
</div>
...
<i class="fi-checkbox"></i> <strong>T</strong>ransform, less fast but fun
</div>
